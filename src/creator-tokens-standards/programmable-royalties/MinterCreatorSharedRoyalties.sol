...
import "@openzeppelin-v4/contracts/interfaces/IERC2981.sol";
import "@openzeppelin-v4/contracts/proxy/Clones.sol";
...
abstract contract MinterCreatorSharedRoyaltiesBase is IERC2981, ERC165 {
     ...
     */
    function _getPaymentSplitterForTokenOrRevert(uint256 tokenId)
        private
        view
        returns (IPaymentSplitterInitializable)
    {
...
abstract contract MinterCreatorSharedRoyalties is MinterCreatorSharedRoyaltiesBase {
    ...
    constructor(
        ...
        _setRoyaltyFeeNumeratorAndShares(
            royaltyFeeNumerator_, minterShares_, creatorShares_, creator_, paymentSplitterReference_
        );
