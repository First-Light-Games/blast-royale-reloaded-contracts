...
contract NoobFixedStakingScript is Script {
    ...
    uint256 public tgeStart = 1731499200; // 13/11 12:00 UTC
    uint256 public rewardLimit = 40 * 1_000_000 * 1e18;

    function run() external {
        uint256 deployerPrivateKey = vm.envUint("PRIVATE_KEY");
        vm.startBroadcast(deployerPrivateKey);

        NoobStaking fixedStaking = new NoobStaking( noobAddress, adminAddress, tgeStart, rewardLimit, priceFeedAddress);
