...
import "@openzeppelin-v4/contracts/utils/cryptography/draft-EIP712.sol";
...
abstract contract SignedApprovalMintBase is MaxSupplyBase, EIP712 {
    ...
    function claimSignedMint(bytes calldata signature, uint256 quantity) external {
        ...
        bytes32 hash = _hashTypedDataV4(
            keccak256(abi.encode(keccak256("Approved(address wallet,uint256 quantity)"), _msgSender(), quantity))
        );
