...
abstract contract ClaimableHolderMintBase is ClaimPeriodBase, MaxSupplyBase {
    ...
    function _claim(ClaimableRootCollection storage rootCollectionDetails, uint256 rootCollectionTokenId) internal {
        ...
        (bool claimed, uint256 slot, uint256 offset, uint256 slotValue) =
            _isClaimed(rootCollectionDetails, rootCollectionTokenId);
        if (claimed) {
    ...
    function _getNumberOfTokenTrackerSlots(uint256 maxSupply_)
        internal
        pure
