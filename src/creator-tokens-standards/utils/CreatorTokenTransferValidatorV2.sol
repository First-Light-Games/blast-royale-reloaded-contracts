...
contract CreatorTokenTransferValidatorV2 is EOARegistry, ICreatorTokenTransferValidatorV2 {
     ...
     */
    function transferSecurityPolicies(TransferSecurityLevels level)
        public
        pure
        returns (CallerConstraints callerConstraints, ReceiverConstraints receiverConstraints)
    {
     ...
     */
    function setTransferSecurityLevelOfCollection(address collection, TransferSecurityLevels level) external override {
    ...
    function getCollectionSecurityPolicyV2(address collection)
        ...
        view
        override
        returns (CollectionSecurityPolicyV2 memory)
    {
     ...
     */
    function addAccountsToBlacklist(uint120 id, address[] calldata accounts)
        external
        override
        onlyListOwner(id)
     ...
     * @param accounts The addresses of the accounts to add.
     */
    function addAccountsToWhitelist(uint120 id, address[] calldata accounts)
        external
        override
        onlyListOwner(id)
        notZero(accounts.length)
     ...
     */
    function addCodeHashesToBlacklist(uint120 id, bytes32[] calldata codehashes)
        external
        override
        onlyListOwner(id)
     ...
     * @param codehashes The codehashes to add.
     */
    function addCodeHashesToWhitelist(uint120 id, bytes32[] calldata codehashes)
        external
        override
        onlyListOwner(id)
        notZero(codehashes.length)
     ...
     */
    function removeAccountsFromBlacklist(uint120 id, address[] calldata accounts)
        external
        override
        onlyListOwner(id)
        notZero(accounts.length)
     ...
     * @param accounts The addresses of the accounts to remove.
     */
    function removeAccountsFromWhitelist(uint120 id, address[] calldata accounts)
        external
        override
        onlyListOwner(id)
        notZero(accounts.length)
     ...
     */
    function removeCodeHashesFromBlacklist(uint120 id, bytes32[] calldata codehashes)
        external
        override
        onlyListOwner(id)
        notZero(codehashes.length)
     ...
     * @param codehashes The codehashes to remove.
     */
    function removeCodeHashesFromWhitelist(uint120 id, bytes32[] calldata codehashes)
        external
        override
        onlyListOwner(id)
        notZero(codehashes.length)
     ...
     * @return           An array of blacklisted codehashes.
     */
    function getBlacklistedCodeHashesByCollection(address collection)
        external
        view
        override
     ...
     * @return           An array of whitelisted codehashes.
     */
    function getWhitelistedCodeHashesByCollection(address collection)
        external
        view
        override
        returns (bytes32[] memory)
     ...
     */
    function isAccountBlacklistedByCollection(address collection, address account)
        external
        view
        override
        returns (bool)
     ...
     */
    function isCodeHashBlacklistedByCollection(address collection, bytes32 codehash)
        external
        view
        override
        returns (bool)
     ...
     */
    function isCodeHashWhitelistedByCollection(address collection, bytes32 codehash)
        external
        view
        override
        returns (bool)
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(EOARegistry, IERC165) returns (bool) {
        return interfaceId == type(ITransferValidator).interfaceId
            ...
            || interfaceId == type(ICreatorTokenTransferValidatorV2).interfaceId || super.supportsInterface(interfaceId);
    }
    ...
    function _requireCallerIsNFTOrContractOwnerOrAdmin(address tokenAddress) internal view {
        ...
        if (_getCodeLengthAsm(tokenAddress) > 0) {
            ...
            if (!callerHasPermissions) {
                ...
                if (!callerHasPermissions) {
                    try IAccessControl(tokenAddress).hasRole(DEFAULT_ACCESS_CONTROL_ADMIN_ROLE, _msgSender()) returns (
                        bool callerIsContractAdmin
                    ) {
     ...
     * @return 0
     */
    function createPermittedContractReceiverAllowlist(string calldata /*name*/ )
        external
        pure
        override
        returns (uint120)
     ...
     * @notice NO-OP Because V2 Allows Whitelisted Accounts To Be Contract Receivers Automatically.
     */
    function reassignOwnershipOfPermittedContractReceiverAllowlist(uint120, /*id*/ address /*newOwner*/ )
        external
        pure
        override
    {}
     ...
     * @notice NO-OP Because V2 Allows Whitelisted Accounts To Be Contract Receivers Automatically.
     */
    function setPermittedContractReceiverAllowlistOfCollection(address, /*collection*/ uint120 /*id*/ )
        external
        pure
        override
    {}
     ...
     * @notice NO-OP Because V2 Allows Whitelisted Accounts To Be Contract Receivers Automatically.
     */
    function removePermittedContractReceiverFromAllowlist(uint120, /*id*/ address /*receiver*/ )
        external
        pure
        override
    {}
